...
public final class LittleFinger {
	...
	public static LinkedList<BufferedImage> handwrite(
		...
		LinkedList<BufferedImage> article = new LinkedList<>();
	...
	private static BufferedImage deepCopy(final BufferedImage origin) {
